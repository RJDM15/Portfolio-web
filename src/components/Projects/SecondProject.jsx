...
import secondProjectData from "../../Data/Second_project/secondPData";
...
export const SecondProject = ({ language }) => {
    const data = secondProjectData.translations[language] || secondProjectData.translations.es;
                ...
                <section className="relative w-full">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex flex-col gap-y-6">
                        ...
                        <div className="flex flex-wrap gap-4 pt-2">
                            <a href={data.liveUrl || "https://www.feriahub.com/"} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-primary text-tertiary font-bold px-6 py-3 rounded-2xl shadow-lg hover:brightness-110 transition-all cursor-pointer transform hover:-translate-y-0.5">
                                <span>{data.liveText || "Ver Sitio Oficial"}</span>
                                <ExternalLink className="w-5 h-5" />
                            </a>
                            <a href={data.githubUrl || "https://github.com/FNSM-2026-PORTAL/FNSM-Portal-Frontend"} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-secondary border border-neutral/40 text-neutral-light font-bold px-6 py-3 rounded-2xl hover:border-primary/50 hover:text-primary transition-all cursor-pointer transform hover:-translate-y-0.5">
                                ...
                                <span>{data.githubText || "Repositorio en GitHub"}</span>
                            </a>
                        </div>
                    </motion.div>
                </section>
                        ...
                        <div className="bg-secondary border border-neutral-light/30 rounded-2xl p-4 md:p-5 flex flex-col gap-3 shadow-md">
                            ...
                            <div className="flex flex-col gap-2.5">
                                <div className="flex flex-col gap-0.5">
                                    <span className="text-[10px] font-semibold uppercase tracking-wider text-neutral/70">EMPRESA / PROYECTO</span>
